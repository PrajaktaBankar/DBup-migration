...
SET @projectLevelValueForFooter =(SELECT TOP 1    
 ...
 INNER JOIN ProjectPaperSetting PaperSetting WITH (NOLOCK) ON 
 PageSetting.ProjectId = PaperSetting.ProjectId 
...
cast(0 as bit) asPaperOrientation 
from SheetSpecsPageSettings SSPS with (nolock) INNER JOIN LuSpecSheetPaperSize LSSPS with (nolock)
...
begin
	...
	from LuSpecSheetPaperSize with (nolock) where SpecSheetPaperId = 13
end  
