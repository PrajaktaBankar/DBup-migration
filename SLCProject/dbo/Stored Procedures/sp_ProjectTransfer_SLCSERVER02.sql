CREATE PROCEDURE [dbo].[sp_ProjectTransfer_SLCSERVER02]
(
...
BEGIN
	...
	BEGIN TRY
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[ProjectChoiceOption] S WITH (NOLOCK)
		...
		SELECT DISTINCT A.RefStdId AS RefStandardId INTO #tmpRefStdIdInOptionJson FROM [SLCSERVER02].[SLCProject].[dbo].[ReferenceStandard] A WITH (NOLOCK)
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[ProjectReferenceStandard] S WITH (NOLOCK)
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[ProjectSegmentReferenceStandard] S WITH (NOLOCK)
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[Project] S WITH (NOLOCK)
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[ProjectSection] S WITH (NOLOCK)
		WHERE S.ProjectId = @SourceProjectID AND S.CustomerId = @SourceCustomerID AND ISNULL(TemplateId, 0) > 0
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[ProjectSegmentGlobalTerm] S WITH (NOLOCK)
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[HeaderFooterGlobalTermUsage] S WITH (NOLOCK)
		WHERE S.ProjectId = @SourceProjectID AND S.CustomerId = @SourceCustomerID AND S.UserGlobalTermId IS NOT NULL
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[ProjectSegment] S WITH (NOLOCK)
		WHERE S.ProjectId = @SourceProjectID AND S.CustomerId = @SourceCustomerID
		...
		BEGIN
			...
			BEGIN
				...
				BEGIN
					...
					BEGIN
						SELECT @UserGlobalTermId = UserGlobalTermId FROM [SLCSERVER02].[SLCProject].[dbo].[ProjectGlobalTerm] WITH (NOLOCK) WHERE CustomerId = @SourceCustomerID AND ProjectId = @SourceProjectID
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[ProjectSegmentUserTag] S WITH (NOLOCK)
		WHERE S.ProjectId = @SourceProjectID AND S.CustomerId = @SourceCustomerID
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[ReferenceStandard] S WITH (NOLOCK)
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[ReferenceStandardEdition] S WITH (NOLOCK)
		...
		INTO #UsedTemplate
		FROM [SLCSERVER02].[SLCProject].[dbo].[Template] S WITH (NOLOCK)
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[UserGlobalTerm] S WITH (NOLOCK)
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[ProjectUserTag] S WITH (NOLOCK)
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[ReferenceStandardEdition] A WITH (NOLOCK)
		...
		INTO #InsertStyleIds
		FROM [SLCSERVER02].[SLCProject].[dbo].[TemplateStyle] S WITH (NOLOCK)
		INNER JOIN [SLCSERVER02].[SLCProject].[dbo].[Style] S2 WITH (NOLOCK) ON S.CustomerId = S2.CustomerId AND S.StyleId = S2.StyleId
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[Style] S WITH (NOLOCK)
		...
		INTO #TmpSystemTemplates FROM [SLCSERVER02].[SLCProject].[dbo].[Template] T1 WITH (NOLOCK) WHERE T1.CustomerId = @SourceCustomerID AND ISNULL(T1.IsSystem, 0) = 1
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[ProjectAddress] S WITH (NOLOCK)
		WHERE S.ProjectId = @SourceProjectID AND S.CustomerId = @SourceCustomerID
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[UserFolder] S WITH (NOLOCK)
		WHERE S.ProjectId = @SourceProjectID AND S.CustomerId = @SourceCustomerID
		...
		SELECT @SenderProjectViewTypeId = S.[SpecViewModeId] FROM [SLCSERVER02].[SLCProject].[dbo].[ProjectSummary] S WITH (NOLOCK) WHERE S.ProjectId = @SourceProjectID AND S.CustomerId = @SourceCustomerID
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[ProjectSummary] S WITH (NOLOCK)
		WHERE S.ProjectId = @SourceProjectID AND S.CustomerId = @SourceCustomerID
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[ProjectPrintSetting] S WITH (NOLOCK)
		WHERE S.ProjectId = @SourceProjectID AND S.CustomerId = @SourceCustomerID
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[ProjectSection] A WITH (NOLOCK)
		INNER JOIN [SLCSERVER02].[SLCProject].[dbo].[CustomerDivision] B WITH (NOLOCK) ON A.CustomerId = B.CustomerId AND A.DivisionId = B.DivisionId
		...
		--DELETE FROM [SLCSERVER02].[SLCProject].[dbo].[Staging_ProjectSection]
		--WHERE ProjectId = @SourceProjectID AND CustomerId = @SourceCustomerID

		--INSERT INTO [SLCSERVER02].[SLCProject].[dbo].[Staging_ProjectSection]
		--(SectionId, ProjectId, CustomerId)
		--SELECT PS.SectionId, PS.ProjectId, PS.CustomerId
		--FROM [SLCSERVER02].[SLCProject].[dbo].[ProjectSection] PS WITH (NOLOCK)
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[ProjectPageSetting] S WITH (NOLOCK)
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[ProjectPaperSetting] S WITH (NOLOCK)
		LEFT JOIN #tmpProjectSectionSLC PS ON PS.ProjectId = @New_ProjectID AND PS.A_SectionId = S.SectionId
		WHERE S.ProjectId = @SourceProjectID AND S.CustomerId = @SourceCustomerID
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[ProjectGlobalTerm] S WITH (NOLOCK)
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[ProjectGlobalTerm] A WITH (NOLOCK)
		...
		INNER JOIN [SLCSERVER02].[SLCProject].[dbo].[ProjectGlobalTerm] B WITH (NOLOCK) ON A.SourceCustomerId = B.CustomerId AND B.ProjectId = @SourceProjectID
		...
		SELECT DISTINCT ImageId FROM [SLCSERVER02].[SLCProject].[dbo].[ProjectSegmentImage] WITH (NOLOCK) WHERE ProjectId = @SourceProjectID AND CustomerId = @SourceCustomerID

		INSERT INTO #tmpImagesUsedInHeaderFooter (ImageId)
		SELECT DISTINCT ImageId FROM [SLCSERVER02].[SLCProject].[dbo].[ProjectNoteImage] WITH (NOLOCK) WHERE ProjectId = @SourceProjectID AND CustomerId = @SourceCustomerID
		...
		INTO #TGTProImgSLC
		FROM [SLCSERVER02].[SLCProject].[dbo].[ProjectImage] SRC WITH (NOLOCK)
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[ProjectSegmentStatus] S WITH (NOLOCK)
		WHERE S.ProjectId = @SourceProjectID AND S.CustomerId = @SourceCustomerID
		...
		----	AND PS.SegmentId = P.SegmentId
		----INNER JOIN [SLCSERVER02].[SLCMaster].[dbo].[ReferenceStandard] OLDRS WITH (NOLOCK) ON OLDRS.MasterDataTypeId = 1 AND OLDRS.IsObsolete = 0
		...
		--SELECT @OldCount = COUNT(9) FROM [SLCSERVER02].[SLCProject].[dbo].[ProjectSegmentGlobalTerm] WITH (NOLOCK) WHERE CustomerID = @SourceCustomerID AND ProjectId = @SourceProjectID
		--IF @Row_Count > 0
		--BEGIN
		...
		--LEFT JOIN [SLCSERVER02].[SLCProject].[dbo].[ProjectGlobalTerm] G WITH (NOLOCK) ON S.CustomerId = G.CustomerId AND G.UserGlobalTermId = S.UserGlobalTermId
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[Header] S WITH (NOLOCK)
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[Footer] S WITH (NOLOCK)
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[ProjectSegmentChoice] S WITH (NOLOCK)
		WHERE S.ProjectId = @SourceProjectID AND S.CustomerId = @SourceCustomerID
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[SelectedChoiceOption] S WITH (NOLOCK)
		WHERE S.ProjectId = @SourceProjectID AND S.CustomerId = @SourceCustomerID
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[ProjectHyperLink] S WITH (NOLOCK)
		WHERE S.ProjectId = @SourceProjectID AND S.CustomerId = @SourceCustomerID
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[ProjectNote] S WITH (NOLOCK)
		WHERE S.ProjectId = @SourceProjectID AND S.CustomerId = @SourceCustomerID
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[ProjectSegmentTab] S WITH (NOLOCK)
		WHERE S.ProjectId = @SourceProjectID AND S.CustomerId = @SourceCustomerID
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[ProjectSegmentRequirementTag] S WITH (NOLOCK)
		WHERE S.ProjectId = @SourceProjectID AND S.CustomerId = @SourceCustomerID
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[ProjectSegmentImage] S WITH (NOLOCK)
		WHERE S.ProjectId = @SourceProjectID AND S.CustomerId = @SourceCustomerID
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[ProjectNoteImage] S WITH (NOLOCK)
		WHERE S.ProjectId = @SourceProjectID AND S.CustomerId = @SourceCustomerID
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[ProjectSegmentLink] S WITH (NOLOCK)
		WHERE S.ProjectId = @SourceProjectID AND S.CustomerId = @SourceCustomerID
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[ProjectSegmentTracking] S WITH (NOLOCK)
		WHERE S.ProjectId = @SourceProjectID AND S.CustomerId = @SourceCustomerID
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[ProjectDisciplineSection] S WITH (NOLOCK)
		WHERE S.ProjectId = @SourceProjectID AND S.CustomerId = @SourceCustomerID
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[ProjectDateFormat] S WITH (NOLOCK)
		WHERE S.ProjectId = @SourceProjectID AND S.CustomerId = @SourceCustomerID
		...
		--FROM [SLCSERVER02].[SLCProject].[dbo].[MaterialSection] S WITH (NOLOCK)
		--WHERE S.ProjectId = @SourceProjectID AND S.CustomerId = @SourceCustomerID
		...
		--FROM [SLCSERVER02].[SLCProject].[dbo].[LinkedSections] S WITH (NOLOCK)
		--WHERE S.ProjectId = @SourceProjectID AND S.CustomerId = @SourceCustomerID
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[ApplyMasterUpdateLog] S WITH (NOLOCK)
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[ProjectExport] S WITH (NOLOCK)
		WHERE S.ProjectId = @SourceProjectID AND S.CustomerId = @SourceCustomerID
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[SegmentComment] S WITH (NOLOCK)
		WHERE S.ProjectId = @SourceProjectID AND S.CustomerId = @SourceCustomerID
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[TrackAcceptRejectProjectSegmentHistory] S WITH (NOLOCK)
		WHERE S.ProjectId = @SourceProjectID AND S.CustomerId = @SourceCustomerID
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[TrackProjectSegment] S WITH (NOLOCK)
		WHERE S.ProjectId = @SourceProjectID AND S.CustomerId = @SourceCustomerID
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[UserProjectAccessMapping] S WITH (NOLOCK)
		WHERE S.ProjectId = @SourceProjectID AND S.CustomerId = @SourceCustomerID
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[ProjectActivity] S WITH (NOLOCK)
		WHERE S.ProjectId = @SourceProjectID AND S.CustomerId = @SourceCustomerID
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[ProjectLevelTrackChangesLogging] S WITH (NOLOCK)
		WHERE S.ProjectId = @SourceProjectID AND S.CustomerId = @SourceCustomerID
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[SectionLevelTrackChangesLogging] S WITH (NOLOCK)
		WHERE S.ProjectId = @SourceProjectID AND S.CustomerId = @SourceCustomerID
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[TrackAcceptRejectHistory] S WITH (NOLOCK)
		WHERE S.ProjectId = @SourceProjectID AND S.CustomerId = @SourceCustomerID
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[TrackSegmentStatusType] S WITH (NOLOCK)
		WHERE S.ProjectId = @SourceProjectID AND S.CustomerId = @SourceCustomerID
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[FileNameFormatSetting]
		WHERE ProjectId = @SourceProjectID AND CustomerId = @SourceCustomerID
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[SheetSpecsPageSettings]
		WHERE ProjectId = @SourceProjectID AND CustomerId = @SourceCustomerID
		...
		SELECT @New_ProjectID,tgtSect.SectionId ,SD.SectionDocumentTypeId, 
				...
				FROM [SLCSERVER02].[SLCProject].[dbo].[SectionDocument] SD WITH (NOLOCK)  
		...
		FROM [SLCSERVER02].[SLCProject].[dbo].[SheetSpecsPrintSettings] SD WITH (NOLOCK)  
		...
		BEGIN
			...
			FROM [SLCSERVER02].[SLCProject].[dbo].[DocLibraryMapping] DLM WITH(NOLOCK) 
			INNER JOIN [SLCSERVER02].[SLCProject].[dbo].[ImportDocLibrary] IDL WITH(NOLOCK) ON IDL.DocLibraryId = DLM.DocLibraryId 
			...
			FROM [SLCSERVER02].[SLCProject].[dbo].[ImportDocLibrary] IDL WITH(NOLOCK) 
			...
			FROM [SLCSERVER02].[SLCProject].[dbo].[DocLibraryMapping] DLM WITH(NOLOCK) 
			INNER JOIN [SLCSERVER02].[SLCProject].[dbo].[ImportDocLibrary] IDL ON IDL.DocLibraryId = DLM.DocLibraryId 
		...
		--FROM [SLCSERVER02].[SLCProject].[dbo].[Project] P WITH (NOLOCK)
