CREATE PROCEDURE [dbo].[sp_UnArchiveProject_ArchServer02]
(
	@PSLC_CustomerId		INT
	,@PSLC_UserId			INT
	,@PProjectID			INT
...
BEGIN
	...
	BEGIN TRY
		...
		--SELECT @OldCount = COUNT(9) FROM [ARCHIVESERVER02].[SLCProject].[dbo].[ProjectSegmentGlobalTerm] WITH (NOLOCK) WHERE CustomerID = @SLC_CustomerId AND ProjectId = @ProjectID
		--IF @Row_Count > 0
		--BEGIN
		...
		LEFT JOIN [ARCHIVESERVER02].[SLCProject].[dbo].[ProjectGlobalTerm] G WITH (NOLOCK) ON S.CustomerId = G.CustomerId AND G.ProjectId = S.ProjectId
		...
		SELECT @RowExists = COUNT(1) FROM [ARCHIVESERVER02].[SLCProject].[dbo].[MaterialSection] S WITH (NOLOCK)
		WHERE S.ProjectId = @ProjectID AND S.CustomerId = @SLC_CustomerId
		...
		FROM [ARCHIVESERVER02].[SLCProject].[dbo].[ApplyMasterUpdateLog] S WITH (NOLOCK)
		...
		FROM [ARCHIVESERVER02].[SLCProject].[dbo].[ProjectExport] S WITH (NOLOCK)
		WHERE S.ProjectId = @ProjectID AND S.CustomerId = @SLC_CustomerId
		...
		FROM [ARCHIVESERVER02].[SLCProject].[dbo].[SegmentComment] S WITH (NOLOCK)
		WHERE S.ProjectId = @ProjectID AND S.CustomerId = @SLC_CustomerId
		...
		FROM [ARCHIVESERVER02].[SLCProject].[dbo].[TrackAcceptRejectProjectSegmentHistory] S WITH (NOLOCK)
		WHERE S.ProjectId = @ProjectID AND S.CustomerId = @SLC_CustomerId
		...
		FROM [ARCHIVESERVER02].[SLCProject].[dbo].[TrackProjectSegment] S WITH (NOLOCK)
		WHERE S.ProjectId = @ProjectID AND S.CustomerId = @SLC_CustomerId
		...
		FROM [ARCHIVESERVER02].[SLCProject].[dbo].[UserProjectAccessMapping] S WITH (NOLOCK)
		WHERE S.ProjectId = @ProjectID AND S.CustomerId = @SLC_CustomerId
		...
		FROM [ARCHIVESERVER02].[SLCProject].[dbo].[ProjectActivity] S WITH (NOLOCK)
		WHERE S.ProjectId = @ProjectID AND S.CustomerId = @SLC_CustomerId
		...
		FROM [ARCHIVESERVER02].[SLCProject].[dbo].[ProjectLevelTrackChangesLogging] S WITH (NOLOCK)
		WHERE S.ProjectId = @ProjectID AND S.CustomerId = @SLC_CustomerId
		...
		FROM [ARCHIVESERVER02].[SLCProject].[dbo].[SectionLevelTrackChangesLogging] S WITH (NOLOCK)
		WHERE S.ProjectId = @ProjectID AND S.CustomerId = @SLC_CustomerId
		...
		FROM [ARCHIVESERVER02].[SLCProject].[dbo].[TrackAcceptRejectHistory] S WITH (NOLOCK)
		WHERE S.ProjectId = @ProjectID AND S.CustomerId = @SLC_CustomerId
		...
		FROM [ARCHIVESERVER02].[SLCProject].[dbo].[TrackSegmentStatusType] S WITH (NOLOCK)
		WHERE S.ProjectId = @ProjectID AND S.CustomerId = @SLC_CustomerId
		...
		FROM [ARCHIVESERVER02].[SLCProject].[dbo].[FileNameFormatSetting]
		WHERE ProjectId = @ProjectID AND CustomerId = @SLC_CustomerId
		...
		FROM [ARCHIVESERVER02].[SLCProject].[dbo].[SheetSpecsPageSettings]
		WHERE ProjectId = @ProjectID AND CustomerId = @SLC_CustomerId
		...
		FROM [ARCHIVESERVER02].[SLCProject].[dbo].[SectionDocument] SD WITH (NOLOCK)  
		...
		FROM [ARCHIVESERVER02].[SLCProject].[dbo].[SheetSpecsPrintSettings] SD WITH (NOLOCK)  
