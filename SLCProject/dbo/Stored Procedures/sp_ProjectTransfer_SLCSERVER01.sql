CREATE PROCEDURE [dbo].[sp_ProjectTransfer_SLCSERVER01]
(
...
BEGIN
	...
	BEGIN TRY
		...
		SELECT DISTINCT A.RefStdId AS RefStandardId INTO #tmpRefStdIdInOptionJson FROM [SLCSERVER01].[SLCProject].[dbo].[ReferenceStandard] A WITH (NOLOCK)
		...
		BEGIN
			...
			BEGIN
				...
				BEGIN
					...
					BEGIN
						SELECT @UserGlobalTermId = UserGlobalTermId FROM [SLCSERVER01].[SLCProject].[dbo].[ProjectGlobalTerm] WITH (NOLOCK) WHERE CustomerId = @SourceCustomerID AND ProjectId = @SourceProjectID
		...
		FROM [SLCSERVER01].[SLCProject].[dbo].[ReferenceStandard] S WITH (NOLOCK)
		...
		FROM [SLCSERVER01].[SLCProject].[dbo].[ReferenceStandardEdition] S WITH (NOLOCK)
		...
		INTO #UsedTemplate
		FROM [SLCSERVER01].[SLCProject].[dbo].[Template] S WITH (NOLOCK)
		...
		FROM [SLCSERVER01].[SLCProject].[dbo].[UserGlobalTerm] S WITH (NOLOCK)
		...
		FROM [SLCSERVER01].[SLCProject].[dbo].[ProjectUserTag] S WITH (NOLOCK)
		...
		FROM [SLCSERVER01].[SLCProject].[dbo].[ReferenceStandardEdition] A WITH (NOLOCK)
		...
		INTO #InsertStyleIds
		FROM [SLCSERVER01].[SLCProject].[dbo].[TemplateStyle] S WITH (NOLOCK)
		INNER JOIN [SLCSERVER01].[SLCProject].[dbo].[Style] S2 WITH (NOLOCK) ON S.CustomerId = S2.CustomerId AND S.StyleId = S2.StyleId
		...
		FROM [SLCSERVER01].[SLCProject].[dbo].[Style] S WITH (NOLOCK)
		...
		INTO #TmpSystemTemplates FROM [SLCSERVER01].[SLCProject].[dbo].[Template] T1 WITH (NOLOCK) WHERE T1.CustomerId = @SourceCustomerID AND ISNULL(T1.IsSystem, 0) = 1
		...
		SELECT @SenderProjectViewTypeId = S.[SpecViewModeId] FROM [SLCSERVER01].[SLCProject].[dbo].[ProjectSummary] S WITH (NOLOCK) WHERE S.ProjectId = @SourceProjectID AND S.CustomerId = @SourceCustomerID
		...
		FROM [SLCSERVER01].[SLCProject].[dbo].[ProjectSection] A WITH (NOLOCK)
		INNER JOIN [SLCSERVER01].[SLCProject].[dbo].[CustomerDivision] B WITH (NOLOCK) ON A.CustomerId = B.CustomerId AND A.DivisionId = B.DivisionId
		...
		--DELETE FROM [SLCSERVER01].[SLCProject].[dbo].[Staging_ProjectSection]
		--WHERE ProjectId = @SourceProjectID AND CustomerId = @SourceCustomerID

		--INSERT INTO [SLCSERVER01].[SLCProject].[dbo].[Staging_ProjectSection]
		--(SectionId, ProjectId, CustomerId)
		--SELECT PS.SectionId, PS.ProjectId, PS.CustomerId
		--FROM [SLCSERVER01].[SLCProject].[dbo].[ProjectSection] PS WITH (NOLOCK)
		...
		FROM [SLCSERVER01].[SLCProject].[dbo].[ProjectGlobalTerm] A WITH (NOLOCK)
		...
		INNER JOIN [SLCSERVER01].[SLCProject].[dbo].[ProjectGlobalTerm] B WITH (NOLOCK) ON A.SourceCustomerId = B.CustomerId AND B.ProjectId = @SourceProjectID
		...
		SELECT DISTINCT ImageId FROM [SLCSERVER01].[SLCProject].[dbo].[ProjectSegmentImage] WITH (NOLOCK) WHERE ProjectId = @SourceProjectID AND CustomerId = @SourceCustomerID

		INSERT INTO #tmpImagesUsedInHeaderFooter (ImageId)
		SELECT DISTINCT ImageId FROM [SLCSERVER01].[SLCProject].[dbo].[ProjectNoteImage] WITH (NOLOCK) WHERE ProjectId = @SourceProjectID AND CustomerId = @SourceCustomerID
		...
		INTO #TGTProImgSLC
		FROM [SLCSERVER01].[SLCProject].[dbo].[ProjectImage] SRC WITH (NOLOCK)
		...
		----	AND PS.SegmentId = P.SegmentId
		----INNER JOIN [SLCSERVER01].[SLCMaster].[dbo].[ReferenceStandard] OLDRS WITH (NOLOCK) ON OLDRS.MasterDataTypeId = 1 AND OLDRS.IsObsolete = 0
		...
		--SELECT @OldCount = COUNT(9) FROM [SLCSERVER01].[SLCProject].[dbo].[ProjectSegmentGlobalTerm] WITH (NOLOCK) WHERE CustomerID = @SourceCustomerID AND ProjectId = @SourceProjectID
		--IF @Row_Count > 0
		--BEGIN
		...
		--LEFT JOIN [SLCSERVER01].[SLCProject].[dbo].[ProjectGlobalTerm] G WITH (NOLOCK) ON S.CustomerId = G.CustomerId AND G.UserGlobalTermId = S.UserGlobalTermId
		...
		BEGIN
			...
			FROM [SLCSERVER01].[SLCProject].[dbo].[DocLibraryMapping] DLM WITH(NOLOCK) 
			INNER JOIN [SLCSERVER01].[SLCProject].[dbo].[ImportDocLibrary] IDL WITH(NOLOCK) ON IDL.DocLibraryId = DLM.DocLibraryId 
			...
			FROM [SLCSERVER01].[SLCProject].[dbo].[ImportDocLibrary] IDL WITH(NOLOCK) 
			...
			FROM [SLCSERVER01].[SLCProject].[dbo].[DocLibraryMapping] DLM WITH(NOLOCK) 
			INNER JOIN [SLCSERVER01].[SLCProject].[dbo].[ImportDocLibrary] IDL ON IDL.DocLibraryId = DLM.DocLibraryId 
		...
		--FROM [SLCSERVER01].[SLCProject].[dbo].[Project] P WITH (NOLOCK)
