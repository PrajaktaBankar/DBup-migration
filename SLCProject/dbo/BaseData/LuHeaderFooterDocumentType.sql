...
VALUES('Project Specifications'),('Requirements Reports')
GO
INSERT into [dbo].Header
values(NULL	,NULL,NULL,NULL,0,NULL,NULL,1,0,getUtcdate(),0,getUtcdate(),1,NULL,NULL,NULL,1,'Short','Short',NULL,1,NULL,NULL,NULL,NULL,2)
