--Execute on server 2
--Customer Support 31023: SLC User Has {CH#} Issue

use [SLCProject]

DECLARE @ProjectId INT = 4816;
...
LEFT OUTER JOIN ProjectChoiceOption PCO ON PCO.ChoiceOptionCode=SLCMCO.ChoiceOptionCode AND
...
INNER JOIN SLCMaster..SegmentChoice SLCSC ON tblins.ChoiceCode=SLCSC.SegmentChoiceCode 
