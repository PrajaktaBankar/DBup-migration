...
ROW_NUMBER () over(PARTITION BY  CustomerId ORDER BY  CustomerId)as RowNo
 from 
project WHERE   CustomerId=1663 and ISNULL( IsPermanentDeleted,0)=0
...
and CCIS.SectionId=TPSCO.SectionId AND CCIS.SegmentStatusId=TPSCO.SegmentStatusId  AND CCIS.SegmentId=TPSCO.SegmentId
...
,0 AS IsDeleted
 ...
 AND PSC.ProjectId=tblins.ProjectId AND PSC.SectionId=tblins.SectionId AND PSC.SegmentStatusId=tblins.SegmentStatusId AND PSC.SegmentId=tblins.SegmentId
