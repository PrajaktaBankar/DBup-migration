...
update ps SET ps.SegmentDescription='{CH#164387}' FROM ProjectSegment ps WITH(NOLOCK) WHERE ps.projectId= 6243 and
 ps.sectionId=5835970 and  ps.SegmentStatusId=261576781 and CustomerId=383

DECLARE @CustomerId int =383
DECLARE @ProjectId1 int =6243
