--Scenario For M* Missing Choices Data
--Execute it on server 2
--Customer Support 29568: [CH#] Errors After Editing Choices


DECLARE @ProjectId INT = 2415;
...
DROP TABLE IF EXISTS  #TempProjectChoiceOption1
 ...
 PCO.ChoiceOptionCode=SLCMCO.ChoiceOptionCode AND
