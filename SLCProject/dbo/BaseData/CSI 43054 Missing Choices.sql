...
DROP TABLE IF EXISTS #tempInsertMissingUserModificationMissingChoices
 ...
 DROP TABLE IF EXISTS #AllMissingsSegmentChoiceCode
 CREATE table #AllMissingsSegmentChoiceCode( ProjectId int, SectionId int,	ChoiceCode int, CustomerId int,	SegmentStatusId int, SegmentId int, ModifiedBy varchar)
...
AND PSSV.SegmentSource='M') OR (PSSV.SegmentOrigin='U' 
