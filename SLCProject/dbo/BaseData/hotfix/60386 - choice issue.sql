/*
 ...
 Customer Support 60386: Choice Field Corruption CH#
*/
...
SELECT psc.SegmentChoiceCode                        
 ...
 WHERE psc.SectionId = 15928334 
  AND sco.SelectedChoiceOptionId IS NULL                        
  AND pco.CustomerId = 1997                        
  AND pco.ProjectId = 9845                        
...
--------------------------------------------------------------------------
--M*/U
DECLARE @CustomerId int =1997
DECLARE @ProjectId1 int =11987
