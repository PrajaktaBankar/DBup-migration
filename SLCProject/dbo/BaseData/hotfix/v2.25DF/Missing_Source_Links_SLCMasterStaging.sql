...
INNER JOIN [dbo].[SegmentLinkStaging] SLINK WITH (NOLOCK) ON SEC.SectionCode = SLINK.SourceSectionCode AND STS.SegmentStatusCode = SLINK.SourceSegmentStatusCode AND SGMT.SegmentCode != SLINK.SourceSegmentCode AND ISNULL(SLINK.IsDeleted, 0) = 0
