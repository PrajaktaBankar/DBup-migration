...
INNER JOIN [dbo].[SegmentLink] SLINK WITH (NOLOCK) ON SEC.SectionCode = SLINK.TargetSectionCode AND STS.SegmentStatusCode = SLINK.TargetSegmentStatusCode AND SGMT.SegmentCode != SLINK.TargetSegmentCode AND ISNULL(SLINK.IsDeleted, 0) = 0
