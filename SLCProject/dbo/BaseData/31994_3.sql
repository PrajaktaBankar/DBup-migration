--Customer Support 31994: SLC Choice Code Issue {CH#}
--Execute this on Server 1

USE SLCProject
GO

--NOTE:Please Read Below note before execute this script
--Insert Missing master choices data generic script all project of one customer  
...
DECLARE @CustomerId int =23
DECLARE @ProjectId1 int =2496
...
INSERT INTO #tempInsertMissingMasterChoices (ProjectId, RowNo)
	...
	AND CAST(ModifiedDate AS DATE) BETWEEN '1990-01-01' AND '2019-11-03'
