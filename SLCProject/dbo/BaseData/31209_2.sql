...
UPDATE sco SET sco.IsSelected=0 FROM SelectedChoiceOption sco WHERE sco.SegmentChoiceCode=314693 and sco.ProjectId=5286 and sco.CustomerId=1596 and sco.ChoiceOptionCode=644460
DELETE FROM  SelectedChoiceOption WHERE SegmentChoiceCode=314693 AND  ChoiceOptionCode=644462 and	ChoiceOptionSource='M'	 and ProjectId=5286 and CustomerId=1596